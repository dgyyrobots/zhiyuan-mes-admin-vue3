<template>
  ...
  const fetchData = async () => {
    try {
      ...
      // 模拟数据
      const mockData = [
        { month: '1', target: 2, actual: 2, completionRate: 100 },
        { month: '2', target: 3, actual: 4, completionRate: 75 },
        { month: '3', target: 3.5, actual: 3, completionRate: 111.16 },
        { month: '4', target: 4.2, actual: 4, completionRate: 95.24 },
